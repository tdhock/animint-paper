...
\begin{figure*}
  ...
  \caption{Interactive animation of Tornado data built using
    Animint. \textbf{Left}: map of the United States with tornado
...
\begin{figure*}
  ...
  \caption{Interactive animation of Central American climate data
    built using Animint. \textbf{Left}: TODO.}
  \label{fig:climate}
\end{figure*}
