...
% the visualization created with R package animation.
 ...
 \begin{center}
  \begin{tabular}{cccccc}
    ...
    several & 
    %reactive & 
    \href{http://vanderplas.dyndns-remote.com/Shiny/ggvis-animint/}{\texttt{1gidhgS}}
    \\
  \end{tabular}
 \end{center}
\end{table}
...
(\href{http://vanderplas.dyndns-remote.com/Shiny/ggvis-animint/}{\texttt{http://bit.ly/1gidhgS}}). Because ggvis and shiny do not have any
