...
animint, but is also more verbose (TODO: CODE COMPARISON FIGURE).
...
idea of the animation package \citep{animation}. TODO: CODE COMPARISON
FIGURE.
...
ggplot2 \citep{ggplot, ggplot2}. Strictly speaking, ggplot2 is for
