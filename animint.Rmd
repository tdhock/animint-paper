...
In the interactive version, one may click on any state to view it's tornado
counts throughout the years, and/or click on any bar to view the spatial 
distribution of tornado paths for that year, and/or press play to animate
