...
practice, because they can help provide an intuitive understanding of
...
which has several important differences with the animint system that
we propose. Brushing/highlighting of linked iplots is supported for
...
In this example, `clickSelects` is either "Yes" or "No", but as we
show in later examples, `clickSelects` can also be an array of values.
...
currently selected combination of year and region. Below, the text layer for
