...
```{r animation, echo = FALSE, eval = TRUE, fig.cap = "Two frames from an animation of one marker moving from (1, 1) towards (10, 10). A video of the animation with smooth transitions may be viewed online at <https://vimeo.com/160505146>"}
