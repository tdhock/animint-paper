...
precomputing, storing, and loading an unnecessarily large amount of data.
...
In this scenario, it may be worthwhile to try compile `R` functions so that
the web browser can run them using a technlogy like `WebAssembly`
