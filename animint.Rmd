...
the web browser can run them using a technology like `WebAssembly`
...
before render time. As elucidated in our supplementary materials,
...
such as: zooming, panning, and plot re-sizing.
