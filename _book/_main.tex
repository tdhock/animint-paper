...
occur. We propose the \texttt{R} package \textbf{animint} for rapid
creation of linked and animated web graphics through a simple extension
of \textbf{ggplot2}'s implementation of the Grammar of Graphics. The
...
Graphics API to create interactive web graphics that do not require
