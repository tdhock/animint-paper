...
The interactive version also makes use of additional animation options
to automatically increment the selected year every few seconds, allowing
us to visualize the evolution of the relationship between life
expectancy and fertility rate. These options are explained in detail in
